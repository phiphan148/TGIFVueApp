<template>
    <div class="card-body container" style="height: 100%">
        <div class="row h-100">
                ...
                <div id="summary">
                    <div class="collapse" id="collapseSummary">
                        ...
                        <p>In the West, the idea that government should be open to public scrutiny and susceptible to
                            ...
                            on the eighteenth-century public sphere.</p>
                        <p>Influenced by Enlightenment thought, the revolutions in America (1776) and France (1789),
                            ...
                            of eminent liberal politicians and writers, Bentham, Mill and Acton prominent among the latter.</p>

                        <p>Open government is widely seen to be a key hallmark of contemporary democratic practice and
                            ...
                            in 1951 (superseded by new legislation in 1999).</p>
                    ...
                    <a class="collapsed text-info" data-toggle="collapse" href="#collapseSummary" aria-expanded="false" aria-controls="collapseSummary"></a>
                </div>
            </div>
            <div class="img-home col-md-4 col-sm-12 col-12 text-center justify-content-center align-self-center">
                <img src="../assets/body.png" class="img-fluid" alt="logo">
            </div>
        </div>
    </div>
</template>
